...
{G1}[{A}={G4}]{G4} UPDATE BY {A}:{G4} ZEHEN–AF
{A}──────────────────────────────────────────────────"""
...
def _dump1_():
		os.system("cd && git clone https://github.com/ZEHEN-AF/ZEHENN/S_FILE.git")
